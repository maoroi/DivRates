...
insert <- do.call("rbind", replicate(3, template, simplify = FALSE))
insert$MDD <- c("Nyctophilus_corbeni","Nyctophilus_sherrini","Nyctophilus_shirleyae") # 3 species split from N.major
